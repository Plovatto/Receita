...
const criarNovoUsuarioNoBanco = (nome, sobrenome, email, senha, dataNascimento, callback) => {
  ...
  connection.query(
    ...
    (err, result) => {
      ...
      console.log('Novo usuário cadastrado com ID:', result.insertId, nome, sobrenome, email, hashedSenha, dataNascimento);
